...
public class HandScoreCalculatorTest extends TestCase {
	...
	public void testGetHandScore1() throws Exception {
		...
		HandScore handScore1 = HandScoreCalculator.getHandScore(hand, flop);
		assertEquals(handScore + ", result: " + handScore1, 0, handScore.compareTo(handScore1));
	...
	public void testGetHandScore3() throws Exception {
		...
		kickers.clear();
		flop = new Flop(new Card(Rank.FOUR, Suit.HEARTS), new Card(Rank.ACE, Suit.SPADES), new Card(Rank.ACE, Suit.HEARTS));
		turn = new Card(Rank.TEN, Suit.SPADES);
		river = new Card(Rank.JACK, Suit.DIAMONDS);
		kickers.add(river);
		kickers.add(hand.getCard1());
		kickers.add(turn);
		handScore = new HandScore(HandType.TWO_PAIRS, Rank.ACE, kickers);
		HandScore handScore1 = HandScoreCalculator.getHandScore(hand, flop, turn, river);
		assertEquals(handScore + ", result: " + handScore1, 0, handScore.compareTo(handScore1));
	...
	public void testGetHandScore4() throws Exception {
		...
		HandScore handScore1 = HandScoreCalculator.getHandScore(hand, communityCards);
		assertEquals(handScore + ", result: " + handScore1, 0, handScore.compareTo(handScore1));
		...
		kickers.addAll(Arrays.asList(hand.getCards()));
		handScore = new HandScore(HandType.TWO_PAIRS, Rank.ACE, kickers);
		handScore1 = HandScoreCalculator.getHandScore(hand, communityCards);
		assertEquals(handScore + ", result: " + handScore1, 0, handScore.compareTo(handScore1));
	...
	public void testRegression() {
		...
		assertEquals(4, handScore.getKickers().size());
		...
		assertNotNull(handScore.getKickers());
		ArrayList<Card> kickers = new ArrayList<>(4);
		kickers.add(cc.getFlop().getCard1());
		kickers.add(new Card(Rank.FIVE, Suit.HEARTS));
		kickers.add(cc.getTurn());
		kickers.add(cc.getFlop().getCard3());
		...
		assertEquals(Rank.JACK, handScore.getRank());
		assertNotNull(handScore.getKickers());
		kickers = new ArrayList<>(4);
		kickers.add(cc.getTurn());
		kickers.add(cc.getRiver());
		kickers.add(hand.getCard1());
		kickers.add(hand.getCard2());
		assertEquals(new HandScore(HandType.FLUSH, Rank.JACK, kickers), handScore);
